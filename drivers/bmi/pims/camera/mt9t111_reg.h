...
struct mt9t111_regs fmt_2048x1536_7fps[] = {
	...
	{0, 0x990, 0x0608}, //      = 1544
	{0, 0x98E, 0x6C00}, //Output Width (B)
	{0, 0x990, 0x0800}, //      = 2048
	{0, 0x98E, 0x6C02}, //Output Height (B)
	{0, 0x990, 0x0600}, //      = 1536
	{0, 0x98E, 0xEC8E}, //JPEG (B)
	{0, 0x990, 0x00}, //      = 0
	{0, 0x98E, 0x6CA0}, //Adaptive Output Clock (B)
	{0, 0x990, 0x0000, 0x0040}, //      = 0
	{0, 0x98E, 0x484A}, //Row Start (B)
	{0, 0x990, 0x004}, //      = 4
	{0, 0x98E, 0x484C}, //Column Start (B)
	{0, 0x990, 0x004}, //      = 4
	{0, 0x98E, 0x484E}, //Row End (B)
	{0, 0x990, 0x60B}, //      = 1547
	{0, 0x98E, 0x4850}, //Column End (B)
	{0, 0x990, 0x80B}, //      = 2059
	{0, 0x98E, 0x4852}, //Row Speed (B)
	{0, 0x990, 0x0111}, //      = 273
	{0, 0x98E, 0x4854}, //Read Mode (B)
	{0, 0x990, 0x0024}, //      = 36
	{0, 0x98E, 0x4857}, //Fine Correction (B)
	{0, 0x990, 0x008C}, //      = 140
	{0, 0x98E, 0x4859}, //Fine IT Min (B)
	{0, 0x990, 0x01F1}, //      = 497
	{0, 0x98E, 0x485B}, //Fine IT Max Margin (B)
	{0, 0x990, 0x00FF}, //      = 255
	{0, 0x98E, 0x4865}, //Base Frame Lines (B)
	{0, 0x990, 0x0845}, //      = 2117
	{0, 0x98E, 0x4867}, //Min Line Length (B)
	{0, 0x990, 0x0378}, //      = 888
	{0, 0x98E, 0x486D}, //Line Length (B)
	{0, 0x990, 0x0DEA}, //      = 3562
	{0, 0x98E, 0x4873}, //Contex Width (B)
	{0, 0x990, 0x0808}, //      = 2056
	{0, 0x98E, 0x4875}, //Context Height (B)
	{0, 0x990, 0x0608}, //      = 1544
	...
	{0, 0x990, 0x94}, //      = 148
	{0, 0x98E, 0xC930}, //period_50Hz (B) MSB
	{0, 0x990, 0x00}, //      = 0
	{0, 0x98E, 0xC88D}, //period_60Hz (B)
	{0, 0x990, 0x7C}, //      = 124
	{0, 0x98E, 0xC92E}, //period_60Hz (B) MSB
	{0, 0x990, 0x00}, //      = 0
	...
	{0, 0x990, 0x000E}, //      = 14
	{0, 0x98E, 0x488E}, //RX FIFO Watermark (B)
	{0, 0x990, 0x0014}, //      = 20
	{0, 0x98E, 0x6CAA}, //TX FIFO Watermark (B)
	{0, 0x990, 0x00E6}, //      = 230
};
