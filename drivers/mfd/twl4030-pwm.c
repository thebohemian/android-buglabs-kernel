...
static void twl_pwm_config_work(struct work_struct *work)
{
	...
	switch(pwm->pwm_id) {
	case 0:
	  twl4030_i2c_write_u8(TWL4030_MODULE_PWMA, dat_on, PWMON);
	  twl4030_i2c_write_u8(TWL4030_MODULE_PWMA, dat_off, PWMOFF);
	  break;
	case 1:
	  twl4030_i2c_write_u8(TWL4030_MODULE_PWMB, dat_on, PWMON);
	  twl4030_i2c_write_u8(TWL4030_MODULE_PWMB, dat_off, PWMOFF);
	  break;
	default:
	  return;
	}  
